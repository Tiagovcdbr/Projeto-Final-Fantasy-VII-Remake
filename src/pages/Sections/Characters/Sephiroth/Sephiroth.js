...
const Sephiroth = () => {
  return (
    <Container>
      ...
      />
      <audio
        src={"/assets/audio/Those not Chosen by the Planet - Destiny Comes.m4a"}
        autoplay='1'
        loop                
      />
       ...
       <ContainerCharacter>
              ...
              <div className='space'>
                <div className='video-thumb-screenshot'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/images/chara_sephiroth_screen_01.jpg' alt='/' />
                  </div>
                ...
                <div className='video-thumb-screenshot-2'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/images/chara_sephiroth_screen_02.jpg' alt='/' />
                  </div>
                  <span className='video-border-top-left'>
                    <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                  </span>
        ...
        <div className='character-profile'>
          <span className='image-background'>
            <img src='/assets/images/characters_profile_sephiroth.png' alt='Redxiii' />
          </span>
        </div>
    </ContainerCharacter>     
    </StyleHeader>    
