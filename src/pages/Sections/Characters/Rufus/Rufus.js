...
const Rufus = () => {
  return (
    <Container>
      ...
      />
      <audio
        src={"/assets/audio/FF VII Remake Mako Reator.m4a"}
        autoplay='1'
        loop                
      />
       ...
       <ContainerCharacter>
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <Fade left>
                <img src='/assets/images/characters_full_rufus.png' alt='/' />
              </Fade>
            </span>
          </div>
          <div className='character-text'>
            <Fade left>
              <h2 className='character-name'>
                <span className='first-name'>Rufus</span>
                &nbsp;
              </h2>
            </Fade>
            <div className='character-bio'>Shinra's vice president and the son of the president. He carries a custom-made shotgun and is protected by Darkstar, a military canine.
                ...
                <div className='space'>
                  <div className='video-thumb-screenshot'>
                    <div className='video-still-house'>
                      <img className='video-thumb-still' src='/assets/images/chara_rufus_screen_01.jpg' alt='/' />
                    </div>
                  ...
                  <div className='video-thumb-screenshot-2'>
                    <div className='video-still-house'>
                      <img className='video-thumb-still' src='/assets/images/chara_rufus_screen_02.jpg' alt='/' />
                    </div>
                    <span className='video-border-top-left'>
                      <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                    </span>
        ...
        <div className='character-profile'>
          <span className='image-background'>
            <Fade right>
              <img src='/assets/images/characters_profile_rufus.png' alt='Tifa' />
            </Fade>
          </span>
        </div>
    </ContainerCharacter>     
