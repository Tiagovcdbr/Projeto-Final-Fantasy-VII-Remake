...
const Aerith = () => {
  return (
    <Container>
      ...
      />
      <audio
        src={"/assets/audio/Final Fantasy VII Remake - Aerith's Theme.m4a"}
        autoplay='1'
        loop                
      />
      <div className='container-hidden-image'>
        <div className='hidden-image'>
          <img src='assets/images/bg_characters_aerith.jpg' alt='/' />
        </div>
      </div>
    <StyleHeader>
                ...
                <div className='space'>
                  <div className='video-thumb-screenshot'>
                    <div className='video-still-house'>
                      <img className='video-thumb-still' src='/assets/images/chara_aerith_screen_01.jpg' alt='/' />
                    </div>
                  ...
                  <div className='video-thumb-screenshot-2'>
                    <div className='video-still-house'>
                      <img className='video-thumb-still' src='/assets/images/chara_aerith_screen_02.jpg' alt='/' />
                    </div>
                    <span className='video-border-top-left'>
                      <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                    </span>
