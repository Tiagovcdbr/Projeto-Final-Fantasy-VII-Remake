...
const Jessie = () => {
  return (
    <Container>
      ...
      />
      <audio
        src={"/assets/audio/Final Fantasy 7 remake Jessie Full theme.m4a"}
        autoplay='1'
        loop                
      />
        ...
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <Fade left>
                <img src='/assets/images/characters_full_jessie.png' alt='/' />
              </Fade>
            </span>
          </div>
          <div className='character-text'>
            <Fade left>
              <h2 className='character-name'>
                <span className='first-name'>Jessie</span>
                &nbsp;
              </h2>
            </Fade>
              <Fade left>
                <div className='character-bio'>A member of the anti-Shinra resistance group Avalanche. In charge of procurement, Jesse obtains all the material needed for the group’s operations, from explosives to fake IDs. Skilled at tinkering with machines, she also earns operating funds by repairing water filtration units and other devices to sell on. A caring sort with a weakness for handsome men.
                ...
                <div className='space'>
                  <div className='video-thumb-screenshot'>
                    <div className='video-still-house'>
                      <img className='video-thumb-still' src='/assets/images/chara_jessie_screen_01.jpg' alt='/' />
                    </div>
                  ...
                  <div className='video-thumb-screenshot-2'>
                    <div className='video-still-house'>
                      <img className='video-thumb-still' src='/assets/images/chara_jessie_screen_02.jpg' alt='/' />
                    </div>
                    <span className='video-border-top-left'>
                      <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                    </span>
