...
const President = () => {
  return (
    <Container>
      ...
      />
      <audio
        src={"/assets/audio/FF7 The Shinra Corporation Music Remake.m4a"}
        autoplay='1'
        loop                
      />
        ...
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <Fade left>
                <img src='/assets/images/characters_full_shinra.png' alt='/' />
              </Fade>
            </span>
          </div>
                ...
                <div className='space'>
                  <div className='video-thumb-screenshot'>
                    <div className='video-still-house'>
                      <img className='video-thumb-still' src='/assets/images/chara_president_screen_01.jpg' alt='/' />
                    </div>
                  ...
                  <div className='video-thumb-screenshot-2'>
                    <div className='video-still-house'>
                      <img className='video-thumb-still' src='/assets/images/chara_president_screen_02.jpg' alt='/' />
                    </div>
                    <span className='video-border-top-left'>
                      <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                    </span>
