       ...
       <ContainerCharacter>
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <img src='/assets/images/characters_full_reno.png' alt='/' />
            </span>
          </div>
          <div className='character-text'>
            <h2 className='character-name'>
              <span className='first-name'>Reno</span>
              &nbsp;
            </h2>
            <div className='character-bio'>A member of the Turks―a special task force within Shinra's General Affairs Division. Reno stands out due to his fiery-red hair, sardonic grin, and cavalier attitude. Using lightning-quick movements and a specially outfitted truncheon, he toys with his opponents as he unleashes a myriad of attacks.
              ...
              <div className='space'>
                <div className='video-thumb-screenshot'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/images/chara_reno_screen_01.jpg' alt='/' />
                  </div>
                ...
                <div className='video-thumb-screenshot-2'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/images/chara_reno_screen_02.jpg' alt='/' />
                  </div>
                  <span className='video-border-top-left'>
                    <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                  </span>
        ...
        <div className='character-profile'>
          <span className='image-background'>
            <img src='/assets/images/characters_profile_reno.png' alt='' />
          </span>
        </div>
    </ContainerCharacter>     
    </StyleHeader>    
