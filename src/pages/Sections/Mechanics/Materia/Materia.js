          ...
          <div className='info-history'>
            <div className='top-border'>
              ...
              <div className='text-history'>
                <span>By attaching materia to your weapons and armor, 
                you can gain new abilities and customize your characters 
                further. Countless types exist, from those that bestow 
                magical spells to versatile actions, as well as some 
                which enable you to summon powerful beings to aid you 
                in battle.</span>   
                
                <span>Moreover, some items have linked materia slots, 
                which allow certain materia to interact with each 
                other and produce unique and surprising effects.</span>
              </div>
            </div>
        </div>
      </StyleHeader>        
...
/*    .video-bg_2 {
  ...
  .container-hidden-image {
    ...
    background-image: url("/assets/images/bg_mechanics_materia.jpg");
