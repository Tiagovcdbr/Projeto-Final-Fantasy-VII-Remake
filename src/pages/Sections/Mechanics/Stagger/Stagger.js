          ...
          <div className='info-history'>
            <div className='top-border'>
              ...
              <div className='text-history'>
                <span>As an enemy sustains damage during battle, the focus 
                gauge below their HP bar will gradually fill up. When this 
                bar is maxed out, the enemy will become staggered for a 
                short time. During this period, it will not only be unable 
                to act, but it will also receive additional damage when 
                attacked.</span>         
              </div>
            </div>
        </div>
...
{/*    .video-bg_2 {
  ...
  .container-hidden-image {
    ...
    background-image: url("/assets/images/bg_mechanics_stagger.jpg");
