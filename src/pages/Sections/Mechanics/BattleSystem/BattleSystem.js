          ...
          <div className='info-history'>
            <div className='top-border'>
              ...
              <div className='text-history'>
                <span>Assess your enemies' strengths and weaknesses, and employ powerful 
                magic and special abilities to fight effectively─such is the guiding principle 
                of this unique system, a mix of traditional command-based FINAL FANTASY 
                combat and real-time action, giving you the power to choose how you play.</span>
                         
                <span>As you build ATB charges in combat, you will be able to perform stronger 
                attacks, cast magic, use items, and execute other battle commands.</span> 
...
/*    .video-bg_2 {
  ...
  .container-hidden-image {
    ...
    background-image: url("/assets/images/bg_mechanics_active.jpg");
