        ...
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <img src='/assets/summons/shiva.png' alt='' />
            </span>
          </div>
          <div className='character-text'>
            <h2 className='character-name'>
              <span className='first-name'>Shiva</span>
              &nbsp;Summon
            </h2>
            <div className='character-bio'>Shiva is a summoning materia 
            in Final Fantasy VII Remake. It summons Shiva, the lady of 
            ice with pale skin clad in silver jewelry and lingerie. 
            Her hip-length teal hair is tied in a high ponytail, she 
            has pointed ears with large hoop earrings, and pale blue eyes. 
            She is clad in metallic lingerie with a crystal in shape of 
            an icicle hanging down from her bra over her navel.
              ...
              <div className='space'>
                <div className='video-thumb-screenshot'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_shiva_screen_01.jpg' alt='/' />
                  </div>
                ...
                <div className='video-thumb-screenshot-2'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_shiva_screen_02.jpg' alt='/' />
                  </div>
                  <span className='video-border-top-left'>
                    <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                  </span>
