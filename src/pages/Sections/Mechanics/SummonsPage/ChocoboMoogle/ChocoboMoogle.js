...
const ChocoboMoogle = () => {
  return (
    <Container>
      ...
      />
      <audio
        src={"/assets/audio/Summon_music_fight.m4a"}
        autoplay='1'
        loop                
      />
      <div className='container-hidden-image'>
        <div className='hidden-image'>
          <img src='assets/images/bg_chocobo_moogle.jpg' alt='/' />
        </div>
      </div>
    <StyleHeader>
       ...
       <ContainerCharacter>
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <img src='/assets/summons/Chocobo_&_Moogle_FFVIIR.png' alt='' />
            </span>
          </div>
          <div className='character-text'>
            <h2 className='character-name'>
              <span className='first-name'>Chocobo & Moogle</span>
              &nbsp;Summon
            </h2>
            <div className='character-bio'>Chocobo & Moogle is a summoning 
            materia in Final Fantasy VII Remake. It summons a moogle riding 
            on a chocobo, two recurring mascot creatures from the Final Fantasy 
            series. The design is based on the Choco/Mog summon from the 
            original Final Fantasy VII, and like the original, is a wind-elemental 
            summon. 
              ...
              <div className='space'>
                <div className='video-thumb-screenshot'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_chocomoogle_screen_01.jpg' alt='/' />
                  </div>
                ...
                <div className='video-thumb-screenshot-2'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_chocomoogle_screen_02.jpg' alt='/' />
                  </div>
                  <span className='video-border-top-left'>
                    <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                  </span>
        ...
        <div className='character-profile'>
          <span className='image-background'>
            <img src='/assets/materias/summon_materia.png' alt='' />
          </span>
        </div>
    </ContainerCharacter>     
    </StyleHeader>    
