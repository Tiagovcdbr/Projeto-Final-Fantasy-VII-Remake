    ...
    <Container>
      ...
      <div className='container-hidden-image'>
        <div className='hidden-image'>
          <img src='assets/images/bg_mechanics_summons.jpg' alt='/' />
        </div>
      </div>
    <StyleHeader>
        ...
        <div className='container'>
          ...
          <div className='character-text'>
            <h2 className='character-name'>
              <span className='first-name'>Ifrit</span>
              &nbsp;Summon
            </h2>
            <div className='character-bio'>Ifrit is a summoning materia 
            in Final Fantasy VII Remake. It summons Ifrit, a fire beast 
            with long curved horns, glowing red eyes, skin that looks like 
            lava and long hair. He has clawed hands and feet and wears 
            leg and arm guards and a loin cloth.
              ...
              <div className='space'>
                <div className='video-thumb-screenshot'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_ifrit_screen_01.jpg' alt='/' />
                  </div>
                ...
                <div className='video-thumb-screenshot-2'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_ifrit_screen_02.jpg' alt='/' />
                  </div>
                  <span className='video-border-top-left'>
                    <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                  </span>
