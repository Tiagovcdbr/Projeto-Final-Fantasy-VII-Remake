    ...
    <Container>
      ...
      <div className='container-hidden-image'>
        <div className='hidden-image'>
          <img src='assets/images/bg_carbuncle.jpg' alt='/' />
        </div>
      </div>
    <StyleHeader>
        ...
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <img src='/assets/summons/carbuncle_summon.png' alt='' />
            </span>
          </div>
          <div className='character-text'>
            <h2 className='character-name'>
              <span className='first-name'>Carbuncle</span>
              &nbsp;
            </h2>
            <div className='character-bio'>Carbuncle is a summoning 
            materia in Final Fantasy VII Remake and "Episode INTERmission". 
            It summons Carbuncle, a small foxlike creature with a red gem 
            on its forehead that supports the party with buffs; though 
            the recurring Carbuncle summon is known for bestowing Reflect, 
            the Final Fantasy VII Remake incarnation rather cuts damage and heals.
              ...
              <div className='space'>
                <div className='video-thumb-screenshot'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_carbuncle_screen_01.jpg' alt='/' />
                  </div>
                ...
                <div className='video-thumb-screenshot-2'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_carbuncle_screen_02.jpg' alt='/' />
                  </div>
                  <span className='video-border-top-left'>
                    <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                  </span>
