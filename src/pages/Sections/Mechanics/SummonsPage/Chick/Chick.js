    ...
    <Container>
      ...
      <div className='container-hidden-image'>
        <div className='hidden-image'>
          <img src='assets/images/bg_chick.jpg' alt='/' />
        </div>
      </div>
    <StyleHeader>
        ...
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <img src='/assets/summons/chocobo-chick-summon-from-ffvii-remake-article_m-1.png' alt='' />
            </span>
          </div>
          <div className='character-text'>
            ...
            "Episode INTERmission". It summons Chocobo Chick, a 
            young yellow chocobo with a large head compared to 
            its body. It has a small beak and green eyes, and 
            large yellow feathers on its head somewhat akin to 
            Cloud Strife's hairstyle.
              ...
              <div className='space'>
                <div className='video-thumb-screenshot'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_chick_screen_01.jpg' alt='/' />
                  </div>
                ...
                <div className='video-thumb-screenshot-2'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_chick_screen_02.jpg' alt='/' />
                  </div>
                  <span className='video-border-top-left'>
                    <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                  </span>
