    ...
    <Container>
      ...
      <div className='container-hidden-image'>
        <div className='hidden-image'>
          <img src='assets/images/bg_leviathan.jpg' alt='/' />
        </div>
      </div>
    <StyleHeader>
        ...
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <img src='/assets/summons/Leviathan_FFVII_Remake.png' alt='' />
            </span>
          </div>
          <div className='character-text'>
            <h2 className='character-name'>
              <span className='first-name'>Leviathan</span>
              &nbsp;Summon
            </h2>
            <div className='character-bio'>Leviathan is a summoning materia in 
            Final Fantasy VII Remake. It summons Leviathan, a colossal flying 
            sea serpent whose non-elemental attacks deal major damage to 
            enemies. 
              ...
              <div className='space'>
                <div className='video-thumb-screenshot'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_leviathan_screen_01.jpg' alt='/' />
                  </div>
                ...
                <div className='video-thumb-screenshot-2'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_leviathan_screen_02.jpg' alt='/' />
                  </div>
                  <span className='video-border-top-left'>
                    <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                  </span>
