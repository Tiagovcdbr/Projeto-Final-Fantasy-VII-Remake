    ...
    <Container>
      ...
      <div className='container-hidden-image'>
        <div className='hidden-image'>
          <img src='assets/images/bg_bahamut_2.jpg' alt='/' />
        </div>
      </div>
    <StyleHeader>
        ...
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <img src='/assets/summons/bahamut.png' alt='' />
            </span>
          </div>
          <div className='character-text'>
            <h2 className='character-name'>
              <span className='first-name'>Bahamut</span>
              &nbsp;Summon
            </h2>
            <div className='character-bio'>Bahamut is a summoning materia 
            in Final Fantasy VII Remake. It summons Bahamut, a dragon whose 
            non-elemental magic attacks deal major damage to enemies. It 
            is based on on the summon from the original Final Fantasy VII 
            with the same appearance and special attack. It is a gray 
            dragon with a humanoid body,
              ...
              <div className='space'>
                <div className='video-thumb-screenshot'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_bahamut_screen_01.jpg' alt='/' />
                  </div>
                ...
                <div className='video-thumb-screenshot-2'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_bahamut_screen_02.jpg' alt='/' />
                  </div>
                  <span className='video-border-top-left'>
                    <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                  </span>
