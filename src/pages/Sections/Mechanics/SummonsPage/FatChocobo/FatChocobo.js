    ...
    <Container>
      ...
      <div className='container-hidden-image'>
        <div className='hidden-image'>
          <img src='assets/images/bg_fatchocobo_2.jpg' alt='/' />
        </div>
      </div>
    <StyleHeader>
        ...
        <div className='container'>
          <div className='character-art'>
            <span className='lazy-image'>
              <img src='/assets/summons/fatchocobo.png' alt='' />
            </span>
          </div>
          <div className='character-text'>
            <h2 className='character-name'>
              <span className='first-name'>Fat Chocobo</span>
              &nbsp;Summon
            </h2>
            <div className='character-bio'>Fat Chocobo is a summoning 
            materia in Final Fantasy VII Remake. It summons Fat 
            Chocobo, a plump yellow chocobo that seems too large to 
            move who tends to always sit down. According to Chadley's 
            Battle Intel data, the fat chocobo is a spirit often 
            associated with fertility and harvests.
              ...
              <div className='space'>
                <div className='video-thumb-screenshot'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_fatchocobo_screen_01.jpg' alt='/' />
                  </div>
                ...
                <div className='video-thumb-screenshot-2'>
                  <div className='video-still-house'>
                    <img className='video-thumb-still' src='/assets/summons/chara_fatchocobo_screen_02.jpg' alt='/' />
                  </div>
                  <span className='video-border-top-left'>
                    <img src='/assets/images/trailer_frame_corner.png' alt='/' />
                  </span>
